...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Contact form - envoi AJAX sans redirection
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            submitBtn.innerHTML = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="spin"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg> Envoi en cours...';
